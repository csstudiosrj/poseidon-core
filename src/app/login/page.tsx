  ...
  return (
    <section className="bg-sea-900 border border-white/5 rounded-2xl p-6 md:p-8 shadow-2xl shadow-black/40 backdrop-blur-sm">
      ...
      <form action={formAction} className="flex flex-col gap-4">
        ...
        <div className="flex flex-col gap-1.5">
          <label htmlFor="password" className="text-[11px] font-semibold text-white/50 uppercase tracking-wider">
            Senha
          </label>
          <input
            type="password"
        ...
        {!isLogin && (
          <div className="flex flex-col gap-1.5">
            <label htmlFor="password-confirm" className="text-[11px] font-semibold text-white/50 uppercase tracking-wider">
              Confirmar senha
            </label>
            <input
              type="password"
        ...
        <div className="flex items-start gap-2.5 mt-1">
          <input
            ...
            defaultChecked={isLogin ? true : undefined}
            disabled={isPending}
            className="mt-0.5 rounded border-white/10 bg-sea-950 text-cyan-500 focus:ring-cyan-500/30 h-3.5 w-3.5 transition-all"
          />
            ...
            {isLogin ? (
              <>
                ...
                <button
                  ...
                  disabled={isPending}
                  className="text-cyan-400 hover:text-cyan-300 transition-colors font-semibold cursor-pointer disabled:opacity-50 bg-transparent border-none p-0 inline text-[11px]"
                >
                  Criar conta
                </button>
              </>
