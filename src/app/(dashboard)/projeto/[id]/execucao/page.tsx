          ...
          <div className="card p-4">
            ...
            <div className="space-y-2 text-xs text-white/50">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-red-400">{glosaTotal.toLocaleString("pt-BR", { style: "currency", currency: "BRL" })}</span>
              </div>
              <div className="flex justify-between">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-mono text-red-400">{rubricasMock.filter((r) => r.executado / r.tetoLegal > 0.95).length} rubricas</span>
              </div>
            </div>
          </div>
        </div>
